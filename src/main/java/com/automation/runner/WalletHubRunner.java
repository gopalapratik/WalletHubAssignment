...
@CucumberOptions(features = "src/main/features/WalletHub.feature", glue = {

		"com.automation.stepdefs" }, monochrome = true, plugin = {
...
public class WalletHubRunner {
	...
	public void tearDownClass() throws IOException {
		...
		htmlReportOutputFile = new File(projectPath + "/output/Reports/WalletHub/" + "WalletHub_Automation_Report_"
